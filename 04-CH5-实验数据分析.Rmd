...
&emsp;&emsp;科学研究是通过规范的研究方法揭示研究对象本质及其规律的过程。科学研究可以分为描述性研究和实验研究。描述性研究在较为自然的情况下收集数据，通过对数据的分析梳理，揭示研究对象的模式和联系。语言研究中，语料库研究大部分属于描述性研究。实验研究则通过系统操纵变量，来观察其他变量的变化，从而探究变量之间的因果关系。心理语言学的大部分研究属于实验研究。实验研究需要在理论的指导下选择操纵的变量和需要控制的变量，同时需要对于变量之间的关系进行预测。本章将首先介绍理论与假设的关系，实验设计的基本概念，数据收集的基本方法，以及实验数据分析的基本流程。
